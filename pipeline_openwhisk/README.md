...
wsk action create resize \
  --docker hibenji/action-python-opencv resize/main.py \
  $COMMON \
  --annotation concurrency 5

wsk action create detect \
  --docker hibenji/action-python-opencv detect/main.py \
  $COMMON \
  --annotation concurrency 5

wsk action create postprocess \
  --docker hibenji/action-python-opencv postprocess/main.py \
  $COMMON \
  --annotation concurrency 5
```
